...
class VoiceToTextParser(
    ...
    private val _staty = MutableStateFlow(VoiceToTestState())
    val state = _staty.asStateFlow()

    val recognizer = SpeechRecognizer.createSpeechRecognizer(app)

    fun startListening(languageCode: String = "rus"){
        _staty.update { VoiceToTestState() }
